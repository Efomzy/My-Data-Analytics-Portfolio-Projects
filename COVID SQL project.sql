...
-- Lets select the data that we will be using
...
-- Now Lets look at total cases verses total deaths
-- This shows the likelihood of dying if one contracts covid in the US
